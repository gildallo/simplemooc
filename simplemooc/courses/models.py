...
class Lesson(models.Model):
    ...
    course = models.ForeignKey(
        Course, verbose_name='Curso', related_name='lessons', on_delete=models.PROTECT)
...
class Material(models.Model):
    ...
    lesson = models.ForeignKey(
        Lesson, verbose_name='Aula', related_name='materials', on_delete=models.PROTECT)
...
class Enrollment(models.Model):
    ...
    course = models.ForeignKey(
        Course, verbose_name='Curso', related_name='enrollments', on_delete=models.PROTECT
    )
...
class Announcement(models.Model):
    ...
    course = models.ForeignKey(
        Course, verbose_name='Curso', related_name='announcements', on_delete=models.PROTECT
    )
...
class Comment(models.Model):
    ...
    announcement = models.ForeignKey(
        Announcement, verbose_name='Anúncio', related_name='comments', on_delete=models.PROTECT
    )
